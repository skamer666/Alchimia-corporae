...
ev1_p:'Kick offs, retraites de direction, comités stratégiques. Sélection de lieux d\'exception en Europe et à l\'international. Logistique entièrement prise en charge.',
...
ev5_p:'Expériences immersives ancrées dans les neurosciences : alignement stratégique, cohésion post fusion, performance commerciale, négociation sous pression, et bien d\'autres formats. Chaque programme est conçu sur mesure et produit un impact mesuré.',
ev5_cta:'Voir des exemples →',
ev6_chip:'Formations & cohésion',
ev6_h:'Formations & développement',
ev6_p:'Modules certifiables en leadership, intelligence émotionnelle, communication et dynamique d\'équipe. Les formats présentés sont des exemples : le catalogue est plus large. Finançables jusqu\'à 50 % via les fonds sectoriels.',
ev6_cta:'Voir des exemples →',
ev_sig_label:'Programmes signature',ev_sig_sub:'Impact mesuré · ROI documenté à 30, 60 et 90 jours',
...
s2_t:'Design',s2_h:'Coconstruction',s2_p:'Concept sur mesure aligné sur vos ambitions stratégiques et votre culture.',
...
ev1_p:'Kick offs, management retreats, strategic committees. Selection of exceptional venues across Europe and internationally. Full logistics handled.',
ev1_cta:'Contact us',
...
ev5_p:'Neuroscience based immersive programmes : strategic alignment, post merger cohesion, sales performance, high pressure negotiation, and many more formats. Each programme is tailored and delivers measurable impact.',
ev5_cta:'See examples →',
ev6_chip:'Training & cohesion',
ev6_h:'Training & development',
ev6_p:'Certifiable modules in leadership, emotional intelligence, communication and team dynamics. The formats shown are examples : the full catalogue is broader. Up to 50% funded via Belgian sectoral funds.',
ev6_cta:'See examples →',
ev_sig_label:'Signature programmes',ev_sig_sub:'Measured impact · ROI documented at 30, 60 and 90 days',
